...
import com.cxf.client.WebServiceTest_Service;

public class CxfServiceApplicationTests {
	
	//通用调用接口
	//https://blog.csdn.net/andyliulin/article/details/53671894
	
	@Test
	public void testTest() {
		String url = "http://192.168.31.155:8089/services/webServiceTest?wsdl";
		//Service service = new ObjectServiceFactory().create(WebServiceTest.class);
	}
	...
	public void testTest2() {
		try {
			WebServiceTest service = (WebServiceTest) new WebServiceTest_Service();
	...
	@Test
	public void testTest21() throws InterruptedException {
